/*
	# vector akta dinamic programming 
	# vector use korla essa muto data push kora jai
		and pop kora jai.
	# vector declaration korta array muto size declaration 
		na korleo hoba;
	# vector basically index ar memory nea kaj kore
	# memory last end point check kore;
	vector push hoy 
	0 1
	1 2
	end point
